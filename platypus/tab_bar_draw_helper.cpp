...
TabBarDrawHelper::TabBarDrawHelper() {
  // const QString k1KSTYLE = ":/1kplatypus/style/default_100_precent/%1";

  tab_bar_bk_image_.load(
      ":/1kplatypus/image/default_100_precent/caption_bg.png");
  tab_bk_normal_image_.load(":/1kplatypus/image/default_100_precent/tab.png");
  tab_bk_hover_image_.load(
      ":/1kplatypus/image/default_100_precent/tab_hover.png");
  tab_bk_selected_image_.load(
      ":/1kplatypus/image/default_100_precent/tab_check.png");

  left_arrow_pixmap_list_.push_back(
      QPixmap(":/1kplatypus/image/default_100_precent/left_arrow_normal.png"));
  left_arrow_pixmap_list_.push_back(QPixmap(
      ":/1kplatypus/image/default_100_precent/left_arrow_disabled.png"));

  right_arrow_pixmap_list_.push_back(
      QPixmap(":/1kplatypus/image/default_100_precent/right_arrow_normal.png"));
  right_arrow_pixmap_list_.push_back(QPixmap(
      ":/1kplatypus/image/default_100_precent/right_arrow_disabled.png"));
}
